import styles from "./section-desktop-large-hero2.module.css";

const SectionDesktopLargeHero2 = () => {
  return (
    <div className={styles.sectiondesktopLargehero2}>
      ...
      <div className={styles.section}>
        ...
        <p className={styles.textp}>
          ...
          they oversee. These challenges include the constant evolution of rules
          and the imperative to ensure their effective dissemination.
        </p>
...
export default SectionDesktopLargeHero2;
